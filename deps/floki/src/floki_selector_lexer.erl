-file("/usr/local/Cellar/erlang/20.0.5/lib/erlang/lib/parsetools-2.1.5/include/leexinc.hrl", 0).
...
-file("/usr/local/Cellar/erlang/20.0.5/lib/erlang/lib/parsetools-2.1.5/include/leexinc.hrl", 14).
...
yystate(45, [123|Ics], Line, Tlen, Action, Alen) ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [96|Ics], Line, Tlen, Action, Alen) ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
...
yystate(45, [38|Ics], Line, Tlen, Action, Alen) ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [36|Ics], Line, Tlen, Action, Alen) ->
...
yystate(45, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(43, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
...
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(45, [C|Ics], Line, Tlen, Action, Alen) when C >= 127 ->
    yystate(47, Ics, Line, Tlen+1, Action, Alen);
...
yystate(43, [10|Ics], Line, Tlen, _, _) ->
    yystate(43, Ics, Line+1, Tlen+1, 21, Tlen);
...
yystate(41, [10|Ics], Line, Tlen, _, _) ->
    yystate(33, Ics, Line+1, Tlen+1, 19, Tlen);
...
yystate(39, [10|Ics], Line, Tlen, _, _) ->
    yystate(39, Ics, Line+1, Tlen+1, 18, Tlen);
...
yystate(31, [10|Ics], Line, Tlen, _, _) ->
    yystate(31, Ics, Line+1, Tlen+1, 17, Tlen);
...
yystate(29, [10|Ics], Line, Tlen, _, _) ->
    yystate(27, Ics, Line+1, Tlen+1, 20, Tlen);
...
yystate(26, [68|Ics], Line, Tlen, Action, Alen) ->
    yystate(30, Ics, Line, Tlen+1, Action, Alen);
...
yystate(24, [86|Ics], Line, Tlen, Action, Alen) ->
    yystate(32, Ics, Line, Tlen+1, Action, Alen);
...
yystate(22, [79|Ics], Line, Tlen, _, _) ->
    yystate(26, Ics, Line, Tlen+1, 22, Tlen);
yystate(22, [78|Ics], Line, Tlen, _, _) ->
    yystate(28, Ics, Line, Tlen+1, 22, Tlen);
...
yystate(15, [10|Ics], Line, Tlen, _, _) ->
    yystate(23, Ics, Line+1, Tlen+1, 22, Tlen);
...
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 33 ->
    yystate(23, Ics, Line, Tlen+1, 22, Tlen);
yystate(15, [C|Ics], Line, Tlen, _, _) when C >= 35 ->
    yystate(23, Ics, Line, Tlen+1, 22, Tlen);
...
yystate(12, [110|Ics], Line, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
yystate(12, [78|Ics], Line, Tlen, Action, Alen) ->
    yystate(28, Ics, Line, Tlen+1, Action, Alen);
...
yystate(8, [10|Ics], Line, Tlen, _, _) ->
    yystate(4, Ics, Line+1, Tlen+1, 22, Tlen);
...
-file("/usr/local/Cellar/erlang/20.0.5/lib/erlang/lib/parsetools-2.1.5/include/leexinc.hrl", 309).
